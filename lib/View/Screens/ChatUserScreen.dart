...
import 'loginScreendefault.dart';
///-----***Created by Dat Tran***------///
...
class _ChatUsersScreenState extends State<ChatUsersScreen> {
  //
  List<ListUserResponse> _chatUsers;
  ...
  _connectSocket() {
    Future.delayed(Duration(seconds: 2), () async {
      print(
          "Connecting Logged In User: ${G.loggedInUser.username}, ID: ${G.loggedInUser.id}");
      G.initSocket();
          ...
          children: <Widget>[
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (_, index) {
                  ListUserResponse user = _chatUsers[index];
