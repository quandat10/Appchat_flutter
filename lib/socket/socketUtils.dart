...
import 'package:appchatdemo/Model/ChatMessageModel.dart';
///-----***Created by Dat Tran***------///
...
class SocketUtils {
  ...
  ListUserResponse _fromUser;


  SocketIO _socket;
  SocketIOManager _manager;

  initSocket(ListUserResponse fromUser) async {
    print('Connecting user: ${fromUser.username}');
  ...
  sendSingleChatMessage(ChatMessageModel chatMessageModel, ListUserResponse toChatUser) {
    print('Sending Message to: ${toChatUser.username}, ID: ${toChatUser.id}');
    if (null == _socket) {
